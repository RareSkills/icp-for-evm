...
We'll create a new project called `HelloWorld` using **DFX** and deploy it locally. _(If you are using Gitpod or Github Codespaces , simply run `dfx deploy` on you terminal and_ [_skip this section_](https://www.notion.so/Local-Canister-Deployment-and-Interaction?pvs=21)_)_
