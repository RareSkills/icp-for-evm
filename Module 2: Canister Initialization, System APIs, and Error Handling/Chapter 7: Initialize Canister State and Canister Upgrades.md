# Initialize Canister State and Canister Upgrades
...
![Screenshot 2025-10-24 at 21.11.28.png](Initialize%20Canister%20State%20and%20Canister%20Upgrades/Screenshot_2025-10-24_at_21.11.28.png)

In the Candid UI, querying `name()` should return `RareSkills`.

![Screenshot 2025-08-19 at 00.20.26.png](Initialize%20Canister%20State%20and%20Canister%20Upgrades/e5e7f611-4b04-4ec6-b4f2-adedf7d2d17c.png)
...
![Screenshot 2025-10-24 at 22.05.19.png](Initialize%20Canister%20State%20and%20Canister%20Upgrades/Screenshot_2025-10-24_at_22.05.19.png)

Query `NAME` and `SYMBOL`, you’ll find that the both their value are empty strings.

![Screenshot 2025-10-24 at 22.19.27.png](Initialize%20Canister%20State%20and%20Canister%20Upgrades/Screenshot_2025-10-24_at_22.19.27.png)
...
![Screenshot 2025-10-24 at 22.45.40.png](Initialize%20Canister%20State%20and%20Canister%20Upgrades/Screenshot_2025-10-24_at_22.45.40.png)

To summarize, canister contracts are upgradeable and there are two types of canister upgrades:

1. **Normal upgrade** — does **not** call the initialization function and **preserves stable memory**; the in-memory heap (temporary state) is reset:
    
    ```rust
    dfx deploy <Canister_Name>
    ```
    
2. **Reinstall** — **calls the initialization function again** and **clears both the heap and stable memory** (including certified data):
