...
![Screenshot 2025-10-22 at 04.51.04.png](.gitbook/assets/screenshot-2025-10-22-at-04.51.04.png)
...
![Screenshot 2025-07-28 at 01.22.15.png](.gitbook/assets/screenshot-2025-07-28-at-01.22.15.png)
...
Paid by the sender **in addition** to `Amount`. | | `Memo` | `u64` | An arbitrary user defined `u64` number.
...
The general formula for computing the account\_id from the principal is
...
![Screenshot 2025-10-22 at 04.52.57.png](.gitbook/assets/screenshot-2025-10-22-at-04.52.57.png)
...
![Screenshot 2025-08-07 at 19.12.20.png](.gitbook/assets/screenshot-2025-08-07-at-19.12.20.png)
...
The default **Fee** is fixed at **10\_000** `e8s` and we’ll set the **memo** to **12345**.
...
![Screenshot 2025-08-07 at 19.35.29.png](.gitbook/assets/screenshot-2025-08-07-at-19.35.29.png)
...
1.  Create a new folder called `AgentJs`. In that folder directory, run the following commands:
    ...
    ![Screenshot 2024-08-29 at 14.35.36.png](.gitbook/assets/screenshot-2024-08-29-at-14.35.36.png)
...
3.  **Build** the transaction data:
    ...
    ```
4. **Sign** and **Send** the transaction: With the transfer arguments prepared, we can now submit the transaction to the ICP Ledger canister. The Agent handles request signing (or leaves it unsigned for anonymous calls) and sends the message to the network.
...
![Screenshot 2025-07-21 at 13.26.42.png](.gitbook/assets/screenshot-2025-07-21-at-13.26.42.png)
...
![Screenshot 2025-08-07 at 19.47.49.png](.gitbook/assets/screenshot-2025-08-07-at-19.47.49.png)
...
![Screenshot 2025-08-07 at 19.45.58.png](.gitbook/assets/screenshot-2025-08-07-at-19.45.58.png)
