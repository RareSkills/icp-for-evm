...
ICP refers to their smart contracts as _canisters_. Canisters store both logic and data, on-chain.

![canister.svg](.gitbook/assets/canister.svg)
...
![Screenshot 2025-12-02 at 01.04.56.png](.gitbook/assets/screenshot-2025-12-02-at-01.04.56.png)
...
![Screenshot 2024-10-12 at 20.21.59.png](.gitbook/assets/screenshot-2024-10-12-at-20.21.59.png)

Upon success, you should be presented with a output similar to the image below.

![Screenshot 2024-10-12 at 20.26.33.png](.gitbook/assets/7773f688-58d3-4322-bba1-f7739d45050d.png)
...
![Screenshot 2024-10-12 at 20.27.47.png](.gitbook/assets/screenshot-2024-10-12-at-20.27.47.png)
...
The Rust code above is a public function `greet()`, which takes a string as its argument (`name`) and returns _“Hello”_ concatenated with `name`.
...
![Screenshot 2025-04-10 at 15.29.08.png](.gitbook/assets/screenshot-2025-04-10-at-15.29.08.png)
...
![Screenshot 2025-09-25 at 00.19.45.png](.gitbook/assets/screenshot-2025-09-25-at-00.19.45.png)
...
![Screenshot 2025-11-26 at 14.47.55.png](.gitbook/assets/screenshot-2025-11-26-at-14.47.55.png)
...
![Screenshot 2025-09-25 at 00.16.49.png](.gitbook/assets/screenshot-2025-09-25-at-00.16.49.png)
...
![Screenshot 2025-08-09 at 21.51.26.png](.gitbook/assets/screenshot-2025-08-09-at-21.51.26.png)
...
![Screenshot 2025-09-25 at 00.22.47.png](.gitbook/assets/screenshot-2025-09-25-at-00.22.47.png)
...
* `<Canister-ID>` can be either the actual _**Canister ID**_ or the _**canister’s name**._
...
*   **dfx canister call with the Canister ID**
    ...
    * `<Function Name>` with `greet`
    ...
    ![Screenshot 2025-06-30 at 20.15.53.png](.gitbook/assets/screenshot-2025-06-30-at-20.15.53.png)
*   **dfx canister call with the canister’s name**
    ...
    ![Screenshot 2025-09-27 at 23.24.42.png](.gitbook/assets/screenshot-2025-09-27-at-23.24.42.png)
