...
![Screenshot 2025-11-20 at 20.45.36.png](Canisters%20are%20Non-Blocking/Screenshot_2025-11-20_at_20.45.36.png)

These other transactions can be query or update calls, which can both **observe** and **modify** the state already committed by **Tx_1**. 
...
![Screenshot 2025-11-20 at 20.49.11.png](Canisters%20are%20Non-Blocking/Screenshot_2025-11-20_at_20.49.11.png)

Try to emulate the example above. Deploy canister `A` and `B`. Call `A.foo()`, then immediately call `get_x()` after, it will return **1**.

![Screenshot 2025-11-28 at 12.58.34.png](Canisters%20are%20Non-Blocking/Screenshot_2025-11-28_at_12.58.34.png)

After `foo()` has returned `true`, call `get_x()` again, it will return **2**.

![Screenshot 2025-11-29 at 16.31.19.png](Canisters%20are%20Non-Blocking/Screenshot_2025-11-29_at_16.31.19.png)
...
![Screenshot 2025-11-20 at 20.50.03.png](Canisters%20are%20Non-Blocking/Screenshot_2025-11-20_at_20.50.03.png)
...
![Screenshot 2025-11-28 at 13.02.59.png](Canisters%20are%20Non-Blocking/Screenshot_2025-11-28_at_13.02.59.png)
...
Because the balance may change while the canister is waiting, we also **re-read** the state when rolling back. That way, we only undo *our* change and preserve any other concurrent updates.
