...
This section describes how we can do obtain a canister’s *Candid Interface* in javascript through dfx.
...
Within your icp_javascript_agent folder, create a new file called `owner.pem` and copy paste the private key that we just exported from dfx. `.pem` is a file format for storing private keys.
